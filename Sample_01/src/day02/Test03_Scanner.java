...
public class Test03_Scanner {
	public static void main(String[] args) {
		...
		System.out.println();
		int ago = Integer.parseInt(keyboard.nextLine());
		
		System.out.println("국어/영어/수학 점수를 입력하세요...");
		System.out.println("입력 예)90 90 70 처럼 점수를 입력후 엔터");
		...
		System.out.println("**** 이벽정보 확인 ****");
		System.out.printf("[이름=%s , 나이=%d]%n",name,ago);
